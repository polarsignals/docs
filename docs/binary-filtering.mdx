...
In addition to that, you can hide multiple binaries at a time! Using the same icicle graph as above, we also want to hide the <em>libpython3.11.so.1.0</em> frames.
