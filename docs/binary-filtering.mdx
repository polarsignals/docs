...
![An icicle graph filtered by a binary](../static/img/binary-filtering/filtered-by-binary.png)
...
![The icicle graph showing filtered data](../static/img/binary-filtering/hidden-binary-filtered.png)

</BrowserWindow>

<br />

In addition to that, you can hide multiple binaries at a time! Using the same icicle graph as above, we also want to hide the <em>image-automation-controller</em> frames.

<BrowserWindow>

![The icicle graph being filtered by multiple binaries](../static/img/binary-filtering/multiple-hidden-binaries.png)
...
![Reset legend vutton](../static/img/binary-filtering/reset-legend.png)
