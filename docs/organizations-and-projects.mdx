...
## Organizations
Organizations are collections of projects. Users are managed on a per-organization basis.
A user may create multiple organizations to separate projects under different companies or teams. 
...
An organization can have multiple users who have access to all projects under the organization. 
Users can invite other users to join and manage the organization.
Check out the [Invite Users](/docs/invite-users) page for more information on inviting users to an organization.
...
Projects are the workspaces for profile data within an organization, mainly to collect profiles that belong to a specific application or environment. 
Profiles within a project can be compared and analysed against each other as required.
