...
2. Navigate to the **Identity & Access Management** tab
...
In the **Invites** section of the Identity & Access Management tab, you can see:
- All active invites
...
After a team member has joined your organization, you can manage their access from the **Role Bindings** section in the Identity & Access Management tab:
...
For detailed information about roles and permissions, see the [User Roles documentation](iam.mdx).
