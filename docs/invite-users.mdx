...
The organization settings page features an **Invite Users** button and also lists all the existing team members that belong to the organization. Clicking on the **Invite Users** button will open up a modal which can be used to either enter the email address of the team member you want to invite or get the invite link which can be shared with team members.
