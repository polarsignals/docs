...
:::info
You'll need a service account token and project ID. See the [Generating Tokens](/docs/generating-tokens) documentation for instructions on creating a service account and generating a token. Replace `<your-project-id>` in the manifest below with your actual project ID.
:::
